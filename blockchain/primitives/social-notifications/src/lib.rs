...
pub const APP_TOPIC: Topic = [
	0x5d, 0x42, 0x66, 0xf5, 0x95, 0x4d, 0xa5, 0x8f, 0x3b, 0x4d, 0xe8, 0x88, 0x93, 0xa1, 0x4c, 0x47,
	0xa2, 0x3d, 0x9f, 0xa9, 0x28, 0x06, 0x7d, 0xf9, 0x35, 0xb2, 0x9a, 0xe6, 0x84, 0x1b, 0xec, 0x38,
];
...
mod tests {
	...
	fn build_statement_broadcast_uses_constant_topic() {
		...
		assert_eq!(statement.topic(0), Some(APP_TOPIC));
		assert_eq!(statement.topic(1), Some(topic_from_name(BROADCAST_NEW_APP_TOPIC_NAME)),);
	}
