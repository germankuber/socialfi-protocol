...
- **SocialFi pallets**: `social-app-registry` (51), `social-profiles` (52), `social-graph` (53), `social-feeds` (54), `social-managers` (55), `sponsorship` (56)
- **pallet-statement** (40) + `sp-statement-store` runtime API for Statement Store support
...
| `src/configs/mod.rs` | All pallet configuration + `NotificationStatementSubmitter` adapter |
