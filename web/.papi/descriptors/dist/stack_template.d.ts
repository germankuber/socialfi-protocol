...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ic2dcamv7dclv2>, false, never>;
        /**
...
type ICalls = {
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<Ialv91g77qcu28>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         ...
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Ierjefv0cqrlgt>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I4dfqs6asu6p31>>;
        /**
    ...
    SocialAppRegistry: {
         ...
         */
        act_as_moderator: TxDescriptor<Anonymize<I75ttmsscg8v6h>>;
    };
    SocialProfiles: {
        /**
    ...
    SocialManagers: {
         ...
         */
        act_as_manager: TxDescriptor<Anonymize<I8p5nckqvjqhaq>>;
    };
    Sponsorship: {
        /**
    ...
    Revive: {
         ...
         */
        eth_substrate_call: TxDescriptor<Anonymize<Isd3pufgr9c9h>>;
        /**
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<Ialv91g77qcu28>>;
    };
};
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I2amb6ed62md7i>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I3nnfgb6fs1fll>>;
    };
    ParachainSystem: {
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I97rkb0g35pp9a>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I97rkb0g35pp9a>>;
    };
    CollatorSelection: {
        /**
    ...
    SocialManagers: {
         ...
         */
        ActedAsManager: PlainDescriptor<Anonymize<I9gqijhglrigpo>>;
        /**
    ...
    Revive: {
         ...
         */
        EthExtrinsicRevert: PlainDescriptor<Anonymize<Ic54chk1ch5eo3>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I5g1atm8a1gmi7>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I5lcff2i51ff95>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I5lcff2i51ff95>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<I4pakvtjsmh7rs>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<Iauf4dr5sc8e37>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<I6mel18jk3tv4u>>;
        /**
         ...
         */
        get_storage: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: FixedSizeBinary<32>], Anonymize<Ia378m6kkra5iu>>;
        /**
         ...
         * doesn't exist, or doesn't have a contract then `Err` is returned.
         */
        get_storage_var_key: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: Binary], Anonymize<Ia378m6kkra5iu>>;
        /**
...
export type Stack_templateDispatchError = Anonymize<Idcjaipav24im0>;
...
export type Stack_templateCallData = Anonymize<I5lcff2i51ff95> & {
    value: {
        type: string;
    };
};
