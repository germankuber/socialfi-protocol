...
const variants: Record<ButtonVariant, string> = {
  ...
  ghost:
    "text-ink-muted hover:text-ink hover:bg-hairline/[0.05]",
  outline:
    "text-ink-muted border border-hairline/10 " +
    "hover:text-ink hover:border-hairline/20",
  danger:
    "text-danger hover:bg-danger/10 border border-danger/20 hover:border-danger/40",
};
